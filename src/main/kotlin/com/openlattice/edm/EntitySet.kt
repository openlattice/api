...
import com.openlattice.data.storage.Datastores
...
@JvmOverloads constructor(
        ...
        @JsonProperty(SerializationConstants.STORAGE_TYPE) var datastore: String = ""
    ...
    init {
        ...
        require((datastore == Datastores.DEFAULT) || !isLinking) {
